...
d3.csv(data).then(function (data,err) {
    ...
    //domain property is where the data is going to fall under, is the scale of the data. Combination of domain and range allows you to convert the position of the svg

    var xScale = d3.scaleLinear().range([0, width]).domain(10, 25)

    var yScale = d3.scaleLinear().range([height, 0]).domain(15, 35);
   ...
   yScale.domain([yMin, yMax])
    ...
    // create chart
defaultAxisLabelX = "poverty"
defaultAxisLabelY = "smokes"
